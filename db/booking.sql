...
COMMENT ON COLUMN specialists.first_name IS 'Имя специалиста.';
COMMENT ON COLUMN specialists.last_name IS 'Фамилия специалиста.';
COMMENT ON COLUMN specialists.name IS 'Полное имя или ФИО (для внутреннего использования).';
...
COMMENT ON COLUMN specialists.phone IS 'Рабочий телефон специалиста.';
COMMENT ON COLUMN specialists.email IS 'Рабочая e-mail почта специалиста.';
COMMENT ON COLUMN specialists.tg_id IS 'Идентификатор пользователя в Telegram (user_id).';
COMMENT ON COLUMN specialists.notes IS 'Заметки по специалисту (особенности, комментарии).';
...
COMMENT ON COLUMN clients.tg_id IS 'Идентификатор клиента в Telegram.';
COMMENT ON COLUMN clients.phone IS 'Телефон клиента.';
COMMENT ON COLUMN clients.email IS 'E-mail клиента.';
COMMENT ON COLUMN clients.first_name IS 'Имя клиента.';
COMMENT ON COLUMN clients.last_name IS 'Фамилия клиента.';
COMMENT ON COLUMN clients.middle_name IS 'Отчество клиента (если применимо).';
...
COMMENT ON COLUMN service_specialists.id IS 'Уникальный идентификатор компетенции.';
...
COMMENT ON COLUMN service_specialists.is_default IS 'Флаг: специалист основной для данной услуги.';
COMMENT ON COLUMN service_specialists.is_active IS 'Флаг активности компетенции.';
COMMENT ON COLUMN service_specialists.notes IS 'Комментарии к компетенции (условия, ограничения, примечания).';
...
COMMENT ON COLUMN specialist_schedules.day_of_week IS 'День недели (0=Воскресенье … 6=Суббота).';
...
COMMENT ON COLUMN appointments.specialist_id IS 'FK → specialists.id. Специалист, который оказывает услугу.';
COMMENT ON COLUMN appointments.client_id IS 'FK → clients.id. Клиент, записанный на услугу.';
...
COMMENT ON COLUMN client_packages.client_id IS 'FK → clients.id. Клиент.';
COMMENT ON COLUMN client_packages.service_id IS 'FK → services.id. Ссылка на пакет (услуга с is_package=TRUE).';
COMMENT ON COLUMN client_packages.total_quantity IS 'Сколько услуг входит в пакет.';
